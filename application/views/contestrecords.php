        ...
        <div class="row">
            ...
            <div class="span4">     
                ...
                <div class="widget">
                    ...
                    <ul class="cat">
                        <li><i class="icon-angle-right"></i><a href="<?= base_url('historico/recordesbolao');?>"> História </a></li>
                        <li><i class="icon-angle-right"></i><a href="<?= base_url('historico/recordesbolaoano/2019');?>"> 2019 </a></li>
                    </ul>
                </div>
            </div>
        </div>
